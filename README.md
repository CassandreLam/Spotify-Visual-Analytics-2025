...
### Key Features:
- **Projected Map (PCA):** Visualizes semantic similarity between tracks.
- **Temporal Filter:** Timeline to explore specific decades.
- **Dynamic Analytics:** Real-time Radar Chart and Histograms based on selection.
